...
if __name__ == '__main__':
	...
	bool_val = bool_input("Do you have a correlation pickle file stored you'd like to continue analyzing [y/n]? ")
	if bool_val == 'y':
		corr_dir = easygui.diropenbox(title='Please select the storage folder.')
	else:	
