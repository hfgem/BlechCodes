...
def plot_spiked_corr(name_corr, spiked_true_corr, taste_interval_names, plot_save_dir):
    ...
    num_segments = [len(spiked_true_corr[taste_key])
                    for taste_key in spiked_true_corr][0]
    segment_names = [
        segment_name for segment_name in spiked_true_corr[taste_names[0]]]
    ...
    for t_i in range(num_taste_intervals):
        ...
        for t_n in range(num_tastes):
            ...
            for s_i in range(num_segments):
                ...
                mean_val = np.nanmean(
                    spiked_true_corr[taste_key][seg_key][t_i, :])
                ax1.axvline(
    ...
    for s_i in range(num_segments):
        for t_n in range(num_tastes):
            ...
            ax3[s_i, t_n].set_title(
                taste_names[t_n] + ' ' + segment_names[s_i])
    ax3[0, 0].legend()
    fig3.tight_layout()
    ...
    for s_i in range(num_segments):
        for t_i in range(num_taste_intervals):
            ...
            ax4[s_i].set_title(taste_interval_names[t_i] +
                               ' ' + segment_names[s_i])
    ax4[0].legend()
    fig4.tight_layout()
