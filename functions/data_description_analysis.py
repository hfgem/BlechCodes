...
class run_data_description_analysis():
	...
	def get_psth_raster(self,):
		...
		pre_taste_dt = int(np.ceil(self.metadata['params_dict']['pre_taste']*(1000/1))) #Convert to ms timescale
		post_taste_dt = int(np.ceil(self.metadata['params_dict']['post_taste']*(1000/1))) #Convert to ms timescale
