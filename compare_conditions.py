...
if __name__ == '__main__':
	...
	unique_given_names = np.unique([data_dict[i]['given_name'] for i in range(num_datasets)]) #How many datasets
	unique_corr_names = np.unique([data_dict[i]['corr_name'] for i in range(num_datasets)]) #How many types of correlation analyses
	...
	unique_segment_names = np.unique(unique_segment_names)
	unique_taste_names = np.unique(unique_taste_names)
	...
	ccf.cross_corr_name(data_dict,cross_corr_dir,unique_corr_names)
